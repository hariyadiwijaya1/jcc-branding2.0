...
use App\Http\Controllers\{DashboardController, BungaController, AnggotaController, HomeController, UserController, RoleController, PinjamanController, DropdownController, AngsuranController};
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('create-loan', [HomeController::class, 'createLoan'])->name('create-loan');
    ...
    Route::get('anggota/export', [PinjamanController::class, 'export'])->name('anggota.export');
